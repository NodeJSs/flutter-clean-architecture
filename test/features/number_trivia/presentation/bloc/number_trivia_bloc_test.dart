...
import 'package:clean_architecture/features/number_trivia/domain/usecases/get_concrete_random_trivia.dart';
...
void main(){
  ...
  group(
    ...
    (){
      ...
      test(
      'should emit [Error] when the input is valid',
      () async{
        // arrange
      ...
      test(
        ...
        () async{
          ...
          // assert
          //mockGetConcreteNumberTrivia.call(Paramas(...))
